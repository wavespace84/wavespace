...
function filterJobs(jobs) {
    return jobs.filter(job => {
        ...
        if (currentFilters.employment !== 'all') {
            ...
            if (currentFilters.employment === '본부장' && job.title.includes('본부장')) empMatch = true;
        ...
        if (currentFilters.keyword !== 'all') {
            ...
            if (currentFilters.keyword === 'private-sale') {
                ...
                keywordMatch = job.title.includes('민간분양') || 
                              ...
                              job.tags.some(tag => tag.includes('민간분양') || tag.includes('일반분양') || tag.includes('민간'));
            } else if (currentFilters.keyword === 'public-sale') {
                // 공공분양: 공공분양, 공공주택, LH분양 관련 키워드
                keywordMatch = job.title.includes('공공분양') || 
                              ...
                              job.tags.some(tag => tag.includes('공공분양') || tag.includes('공공주택') || tag.includes('LH'));
            } else if (currentFilters.keyword === 'rental') {
                // 임대: 임대, 렌탈, 리스 관련 키워드
                keywordMatch = job.title.includes('임대') || 
                              ...
                              job.tags.some(tag => tag.includes('임대') || tag.includes('렌탈') || tag.includes('리스'));
            } else if (currentFilters.keyword === 'move-in') {
                // 입주: 입주, 이사, 입주관리, 사후관리 관련 키워드
                keywordMatch = job.title.includes('입주') || 
                              ...
                              job.tags.some(tag => tag.includes('입주') || tag.includes('이사') || tag.includes('입주관리') || tag.includes('사후관리'));
            } else if (currentFilters.keyword === 'others') {
                // 기타: 컨설팅, 기획, 마케팅, 개발사업, 기타 업무
                keywordMatch = job.title.includes('컨설팅') || 
                              ...
                              job.tags.some(tag => tag.includes('컨설팅') || tag.includes('마케팅') || tag.includes('개발사업') || tag.includes('기획'));
            }
