...
- 뱃지는 목록을 30개 만들어 놓고 획득시 채워지게 표현, 미획득은 흐리게 표시시
...
##### 9.8.2.6 프라이빗 아이템
- 닉네임 비공개: 사용시 닉네임 비공개 선택 (출석쳌, 자유게시판, 유머재미, 구인구직, 분양자료)
...
- 예를 들어:
  ...
  - 분양자료실 → 카드형 게시물 + 포인트 차감 UI + 팝업창으로 썸네일과 첨부자료 다운로드 안내
